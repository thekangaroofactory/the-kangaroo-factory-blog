...
There is always a risk of desynchronization between the cache and the 'source of truth' that needs to be treated with great care (I have been dealing with cache sync issues since day 1 of doing customer support at Dassault Systèmes).
...
Then, in the background, the cache is synchronized with GitHub based on smarter criterion:
