...
In my mind, it raised the need to be able to develop tools with both limited scope & resources available but great ROI because solving daily pains. The development of such tool is considered too costly mostly because the basis takes a lot of time while the feature part can't be developed on its own. A package that would wrap the costly part would also enable those quick wins, hence save time and money.
...
Architecture of the package itself since you can't just put everything in one folder as some objects will be needed for the development or test but not released to the user.\
